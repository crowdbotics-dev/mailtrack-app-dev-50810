"""
Django settings for mailtrack_app_dev_50810 project.
...
ROOT_URLCONF = 'mailtrack_app_dev_50810.urls'
...
WSGI_APPLICATION = 'mailtrack_app_dev_50810.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mailtrack_app_dev_50810 API",
    "DESCRIPTION": "API documentation for mailtrack_app_dev_50810 App",
    "VERSION": "v1",
}
