...
## Project Structure
    ...
    ├── mailtrack_app_dev_50810  # Django project configurations
...
1. Clone this repo and `cd mailtrack_app_dev_50810`
...
2. Clone this repo and `cd mailtrack_app_dev_50810`
